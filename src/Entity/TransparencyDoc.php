...
#[ORM\Entity(repositoryClass: TransparencyDocRepository::class)]
#[Vich\Uploadable]
class TransparencyDoc
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[Vich\UploadableField(mapping: 'transparency_file', fileNameProperty: 'fileName')]
